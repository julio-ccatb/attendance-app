...
import { AlertTriangle, Bell, Calendar, Plus, Users } from "lucide-react";
...
export default function VolunteerDashboard() {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      message: "Incomplete attendance record for Beach Cleanup",
      type: "warning",
    },
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Overview of the latest volunteer activities
            </CardDescription>
          </CardHeader>
          <CardContent>
